    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        <div className="max-w-md w-full bg-white p-8 rounded-2xl border border-slate-200 shadow-sm">
          <h1 className="text-3xl font-bold text-slate-900 mb-3">Reports Module</h1>
          <p className="text-slate-600 mb-6">
            Welcome to the UdyamAI Reports module. Generated detailed business reports and export options.
          </p>
